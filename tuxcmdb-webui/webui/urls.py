...
urlpatterns = [
    ...
    path("datatypes/<int:datatype_id>/edit/", views.datatype_form_view, name="datatype-edit"),
    path("datatypes/<int:datatype_id>/delete/", views.datatype_delete_view, name="datatype-delete"),
